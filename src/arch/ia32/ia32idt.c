/*
    \ \____/ /  \ \
   _/ / __ \ \__/ /     ia32idt.c - Interrupt Descriptor Table definition
   __/ /  \ \____/
...
/**************************************************************************************************/
void sv_idt_init_elem(idt_elem_t *idt_elem,
                      unsigned offset,
...
/**************************************************************************************************/
{
  ...
  sv_idt_init_elem(
    idt + 42, (unsigned)sv_irq_handle_irq10, SV_CODE_SEGMENT_SEL);
  sv_idt_init_elem(
    idt + 43, (unsigned)sv_irq_handle_irq11, SV_CODE_SEGMENT_SEL);
  sv_idt_init_elem(
    idt + 44, (unsigned)sv_irq_handle_irq12, SV_CODE_SEGMENT_SEL);
  sv_idt_init_elem(
    idt + 45, (unsigned)sv_irq_handle_irq13, SV_CODE_SEGMENT_SEL);
  sv_idt_init_elem(
    idt + 46, (unsigned)sv_irq_handle_irq14, SV_CODE_SEGMENT_SEL);
  sv_idt_init_elem(
    idt + 47, (unsigned)sv_irq_handle_irq15, SV_CODE_SEGMENT_SEL);

  sv_idt_init_elem(
    idt + 128, (unsigned)sv_irq_handle_syscall_irq, SV_CODE_SEGMENT_SEL);
}
